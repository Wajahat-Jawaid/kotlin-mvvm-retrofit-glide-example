package com.wajahat.arch.components.data.repository

import com.wajahat.arch.components.data.api.PostsApi
import com.wajahat.arch.components.data.api.PostsApi.BASE_URL
